        ...
        <div className="card">
          <div className="presale_card">
            <div className="tab_box">
              <div className={`tab_panel  + ${active === 0 ? 'active' : ''}`} onClick={() => setActive(0)}>SALE</div>
              <div className={`tab_panel  + ${active === 1 ? 'active' : ''}`} onClick={() => setActive(1)}>CLAIM</div>
            </div>
            {active === 0 ? (
              <div>
                ...
                <Line percent={20} strokeWidth={3} strokeColor="#2a8710" trailColor='#00162fb0' trailWidth={3} style={{ margin: '17px 0 30px 0' }} />
            ...
            <div className="main_detail">
              ...
              <div className="detail_list">
                <div className="list_item">
                  ...
                  <p><a href="http://localhost:3001/presale">0x2d6F...7a34</a></p>
                </div>
                <div className="list_item">
                  <p>Sale Price</p>
                  <p>0.0000000067 ETH</p>
                </div>
                <div className="list_item">
